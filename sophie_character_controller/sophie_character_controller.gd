...
func _ready() -> void:
	...
	var game_manager = get_node("../Level/GameManager")
	connect("area_entered", game_manager._on_area_3d_area_entered)
...
func set_coin(new_coin_count: int) -> void:
	...
	coin_label.text = "Coin Count: " + str(coin_counter) + "/" + str(total_treasures)
